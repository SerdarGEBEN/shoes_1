  ...
  return (
    ...
    >
      <div className="max-lg:max-w-lg max-lg:mx-auto max-lg:h-[80vh] max-lg:min-w-[350px]">
        ...
        <form
          className="max-lg:p-5 bg-gray-100
      
        h-full flex flex-col gap-6 rounded-b-md"
        >
          ...
          <button
            onClick={handleReset}
            type="reset"
            className="border border-gray-100 p-2 rounded-lg hover:bg-gray-dark hover:text-white transition"
          >
            Sıfırla
          </button>
        </form>
